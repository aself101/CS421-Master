...
describe "tbl_equivalent_courses/edit" do
  before(:each) do
  ...
  it "renders the edit tbl_equivalent_course form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", tbl_equivalent_course_path(@tbl_equivalent_course), "post" do
