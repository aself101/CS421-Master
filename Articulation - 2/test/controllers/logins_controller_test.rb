...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { email: @login.email, password: @login.password, user_id: @login.user_id }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { email: @login.email, password: @login.password, user_id: @login.user_id }
    assert_redirected_to login_path(assigns(:login))
  end
