...
ActiveRecord::Schema.define(version: 20140420194106) do
  ...
  create_table "tbl_and_equivalent", primary_key: "eid", force: true do |t|
  ...
  create_table "tbl_approves", primary_key: "aid", force: true do |t|
  ...
  add_index "tbl_approves", ["user_id"], name: "fk_tblApproves_tblAdministrator", unique: true, using: :btree

  create_table "tbl_equivalent_course", primary_key: "eid", force: true do |t|
    t.string "eq_course_alpha", limit: 6,  null: false
    t.string "eq_course_num",   limit: 6,  null: false
    t.string "course_title",    limit: 50, null: false
    t.string "eq_hours",        limit: 5,  null: false
  ...
  create_table "tbl_or_equivalent", primary_key: "eid", force: true do |t|
    t.string "eq_course_alpha", limit: 6,  null: false
    t.string "eq_course_num",   limit: 6,  null: false
    t.string "course_title",    limit: 50, null: false
    t.string "eq_hours",        limit: 5,  null: false
  ...
  create_table "tbl_transfer_course", primary_key: "tid", force: true do |t|
