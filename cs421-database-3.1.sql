...
CREATE TABLE IF NOT EXISTS `tbl_and_equivalent` (
  ...
  CONSTRAINT `fk_tblAnd_Equivalent_tblEquivalent_Course` 
...
CREATE TABLE IF NOT EXISTS `tbl_approves` (
  ...
  CONSTRAINT `fk_tblApproves_tblAdministrator` 
  FOREIGN KEY (`user_id`) 
  REFERENCES `tbl_administrator` (`user_id`) 
  ON DELETE NO ACTION 
  ON UPDATE NO ACTION,
  CONSTRAINT `fk_tblApproves_tblEquivalent_Course` 
  FOREIGN KEY (`eq_course_alpha`, `eq_course_num`) 
  REFERENCES `tbl_equivalent_course` (`eq_course_alpha`, `eq_course_num`) 
  ON DELETE NO ACTION 
  ON UPDATE NO ACTION) 
...
CREATE TABLE IF NOT EXISTS `tbl_equivalent_course` (
  ...
  PRIMARY KEY (`eq_course_alpha`,`eq_course_num`),
  CONSTRAINT `fk_tblEquivalent_Course_tblTransfer_Course` 
  FOREIGN KEY (`eq_course_alpha`, `eq_course_num`) 
...
CREATE TABLE IF NOT EXISTS `tbl_or_equivalent` (
  ...
  `uhh_atr` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`eq_course_alpha`,`eq_course_num`),
  CONSTRAINT `fk_tblOr_Equivalent_tblEquivalent_Course` 
  FOREIGN KEY (`eq_course_alpha`, `eq_course_num`) 
  REFERENCES `tbl_equivalent_course` (`eq_course_alpha`, `eq_course_num`) 
  ON DELETE NO ACTION 
  ON UPDATE NO ACTION) 
...
CREATE TABLE IF NOT EXISTS `tbl_transfers_in` (
  ...
  CONSTRAINT `fk_tblTransfers_In_tblStudent` 
  FOREIGN KEY (`user_id`) 
...
CREATE TABLE IF NOT EXISTS `tbl_transfer_course` (
  ...
  REFERENCES `tbl_institution` (`institution_name`) 
  ON DELETE NO ACTION 
  ON UPDATE NO ACTION) 
  ENGINE=InnoDB DEFAULT CHARSET=utf8;
